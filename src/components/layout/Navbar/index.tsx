...
export default function Navbar() {
  ...
  return (
    <>
      <div className="fixed top-0 left-0 bg-gradient-to-b from-bg via-bg/80 to-transparent backdrop-blur-sm z-50 h-[5.5rem] lg:h-[6.5rem] w-full flex md:px-8 px-5 items-center ">
